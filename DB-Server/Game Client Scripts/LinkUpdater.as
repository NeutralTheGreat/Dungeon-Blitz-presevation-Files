package
{
   ...
   public class LinkUpdater
   {
      ...
      private function method_1379(param1:Packet) : void
      {
         ...
         if(_loc32_ = param1.method_11())
         {
            ...
            while(_loc52_ < _loc51_)
            {
               ...
               else
               {
                  ...
                  _loc79_ = param1.method_11() ? param1.method_6(class_21.const_50) : 0;
                  if(_loc74_)
                  {
            ...
            while(_loc52_ < _loc54_)
            {
               ...
               if(_loc84_ = class_14.var_464[_loc83_])
               {
            ...
            while(_loc52_ < _loc55_)
            {
               ...
               if(_loc89_ = class_14.var_224[_loc85_])
               {
            ...
            while(param1.method_11())
            {
               ...
               if(_loc91_)
               {
                  if(_loc93_ = class_64.method_56(_loc91_))
                  {
            ...
            while(param1.method_11())
            {
               ...
               if(_loc96_ = class_14.var_629[_loc94_])
               {
            ...
            while(param1.method_11())
            {
               ...
               if(_loc99_ = class_14.var_838[_loc97_])
               {
            ...
            {
               if((_loc105_ = class_14.var_238[_loc57_]).var_1775)
               {
                  if(param1.method_11())
                  {
               ...
               else if(param1.method_11())
               {
                  if(!param1.method_11())
                  {
                     _loc108_ = _loc105_.var_908 > 1 ? param1.method_4() : 0;
            ...
            if(param1.method_11())
            {
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     if(_loc120_ = param1.method_6(class_64.const_499))
                     {
               ...
               if(param1.method_11())
               {
                  ...
                  _loc131_ = uint((_loc130_ = this.var_1.mAbilityBook.GetCurrRankByAbilityID(_loc128_)) + 1);
                  if((_loc132_ = class_14.var_478[_loc128_]) && _loc132_.var_90 >= 4 && _loc131_ == 1)
                  {
                     _loc131_ = 2;
                  }
                  if(_loc133_ = class_10.method_591(_loc128_,_loc131_))
                  {
               ...
               if(param1.method_11())
               {
                  ...
                  if(_loc144_ = this.var_1.mEggPetInfo.GetPetDataByIDIteration(_loc141_,_loc142_))
                  {
         ...
         var _loc34_:Boolean;
         if((_loc34_ = param1.method_11()) && Boolean(_loc20_))
         {
            _loc52_ = 0;
         ...
         var _loc35_:EntType;
         if((Boolean(_loc35_ = !!this.var_1.clientEnt ? this.var_1.clientEnt.entType : _loc35_)) && Boolean(_loc7_))
         {
         ...
         var _loc37_:uint;
         if(Boolean(!!(_loc37_ = param1.method_4()) ? class_14.var_464[_loc37_] : null))
         {
         ...
         var _loc44_:class_3;
         if((Boolean(_loc44_ = class_14.var_419[_loc42_])) && Boolean(this.var_1.clientEnt))
         {
            this.var_1.clientEnt.method_190(_loc44_);
            this.var_1.screenHudTopRight.Refresh();
         }
         var _loc45_:class_3;
         if(_loc45_ = class_14.var_419[_loc43_])
         {
         ...
         while(_loc52_ < _loc47_)
         {
            ...
            if(_loc156_ = this.var_1.method_111(_loc153_))
            {
         ...
         var _loc48_:Entity;
         if(_loc48_ = this.var_1.clientEnt)
         {
            if(_loc32_)
            {
            ...
            {
               if(_loc158_ = (Boolean(_loc157_ = PowerType.var_440)) && Boolean(_loc157_.var_381) ? class_14.buffTypesDict[_loc157_.var_381[0]] : null)
               {
            ...
            {
               if(_loc160_ = (Boolean(_loc159_ = class_14.powerTypesDict[_loc48_.mEquipPet.mPetType.var_1138])) && Boolean(_loc159_.var_381) ? class_14.buffTypesDict[_loc159_.var_381[0]] : null)
               {
         ...
         var _loc49_:Level;
         if(Boolean((_loc49_ = this.var_1.level).internalName) && Boolean(Level.method_73(_loc49_.internalName)) && !_loc49_.var_333)
         {
